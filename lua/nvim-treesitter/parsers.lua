...
return {
  ...
  apex = {
    install_info = {
      location = 'apex',
      revision = 'f5a1d2188ff711a06c6a8daa65bbf2f17c8378a5',
  ...
  elixir = {
    install_info = {
      revision = 'd30189581a8b2802f237884287fdb7c40f32a041',
  ...
  powershell = {
    filetype = 'ps1',
    install_info = {
      revision = '7e6ccf19774a098bb3c996690c65cc1a6f439dc0',
  ...
  sql = {
    install_info = {
      branch = 'gh-pages',
      generate_from_json = true,
      revision = '035354ea51c835cfe8fc9abf81bb081965a42b4c',
  ...
  templ = {
    install_info = {
      generate_from_json = true,
      revision = 'ebcb4f7a6abde0156f7f2bf7744592afd0ec38b0',
