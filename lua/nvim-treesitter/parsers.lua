...
return {
  ...
  desktop = {
    install_info = {
      revision = 'd52964c67d98eaedabca6ed1ec21ae54a522e8f8',
  ...
  editorconfig = {
    install_info = {
      revision = 'cfdc59ccdc13c324962a02e104743e0e23ca1010',
  ...
  mlir = {
    install_info = {
      generate = true,
      revision = '5b8867f59954c9cae76f2aa1ac88ae513de412bd',
  ...
  nix = {
    install_info = {
      revision = '0240bbfce72d155823c3b7edec622dedd580bf02',
  ...
  nu = {
    install_info = {
      revision = '7e0f16f608a9e804fae61430ade734f9f849fb80',
  ...
  php = {
    install_info = {
      location = 'php',
      revision = '6918e6908d78780ddd996b9fcbaa835b42782d5b',
  ...
  templ = {
    install_info = {
      generate_from_json = true,
      revision = '73a558744fff7c4560f4801e14a467811f608556',
  ...
  v = {
    install_info = {
      ...
      revision = 'bb0a1bd4c2a56f6b191b7d051ea3f2976c3bcb11',
  ...
  vhdl = {
    install_info = {
      revision = 'b4e73e0c0a09af83e10145953cfbd3652c2833dc',
  ...
  xresources = {
    install_info = {
      revision = 'a75056c2e1bed83c338ff394dbb7c653db210432',
